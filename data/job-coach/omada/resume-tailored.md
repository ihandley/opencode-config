...
Senior Software Engineer with 20+ years building and owning backend systems at scale. Deep expertise in Go and distributed systems on AWS and GCP, with a strong track record leading teams and improving reliability. Background in healthcare data platforms and high-volume transaction systems. Actively building AI agents and LLM integrations to automate workflows.
...
**Backend:** REST APIs, Microservices, Distributed Systems, System Design, gRPC

**Cloud:** AWS, GCP, Azure, Kubernetes, Docker

**Data:** PostgreSQL, SQL Server, ETL, Big Data, RabbitMQ, Messaging
