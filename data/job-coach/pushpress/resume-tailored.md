...
Senior Software Engineer with 20+ years building and owning product-facing backend systems at scale. Deep expertise in Go and distributed systems on AWS and GCP, with a strong track record leading teams and shipping features that improve reliability and user experience. Experienced building payment and transaction systems, APIs, and developer tooling. Actively building AI agents and LLM integrations to automate workflows.

---

## Skills

**Languages:** Go, Python, JavaScript, Node.js, C#

**Backend:** REST APIs, Microservices, Distributed Systems, System Design, Event-Driven Architecture

**Cloud:** AWS, GCP, Azure, Kubernetes, Docker

**Data:** PostgreSQL, SQL Server, ETL, RabbitMQ, Messaging

**AI/ML:** AI Agents, LLMs, MCP, RAG

**Leadership:** Team Leadership, Cross-functional Collaboration, Mentorship
...
- Built AI agents and MCP integrations to automate internal workflows
...
- Integrated backend systems with PostgreSQL and Azure storage services
...
- Collaborated with global teams to support production systems
