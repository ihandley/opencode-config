...
Senior Software Engineer with 20+ years building enterprise backend systems. Expert in Go and Python with deep experience in distributed systems, microservices, and cloud infrastructure (AWS/GCP). Strong background in financial services and healthcare platforms. Actively building AI agents and LLM integrations to automate workflows.

---

## Skills

**Languages:** Go, Python, TypeScript, Node.js, C#

**Backend:** REST APIs, gRPC, Microservices, Distributed Systems, System Design

**Cloud:** AWS, GCP, Azure, Kubernetes, Docker, Terraform

**Data:** PostgreSQL, SQL Server, ETL, Big Data

**AI/ML:** AI Agents, LLMs, MCP, RAG
...
- Owned Go-based backend services powering high-volume chargeback systems (~millions of transactions/month)
- Designed distributed systems across AWS and GCP improving reliability and reducing incident frequency
- Led team of engineers for 2 years, improving delivery timelines and reducing deployment friction
- Built AI agents and MCP integrations to automate internal troubleshooting workflows
- Explored RAG-based approaches for domain-specific knowledge retrieval
...
- Integrated backend with PostgreSQL and Azure storage services
